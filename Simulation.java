...
public class Simulation {
    ...
    public static void main(String[] args) {
        ...
        // int finalTAvg = 0;                       //
        // int finalCAvg = 0;                       //For automation of the 5 runs
        // for (int f = 0; f < 5; f++) {            //
            int pop = 0;
            int thieves = 0;
            ...
            // finalTAvg += (thiefAveragesSum / years);             //For automation of the 5 runs
            // finalCAvg += (citizenAveragesSum / years);
        // }

        // System.out.println("\nFINAL CITIZEN AVERAGE : " + (finalCAvg / 5));
        // System.out.println("\nFINAL THIEF AVERAGE : " + (finalTAvg / 5));
